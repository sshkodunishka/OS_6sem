...
VOID WINAPI ServiceMain(DWORD dwArgc, LPTSTR* lpszArgv) {
	...
	const wchar_t* directoryPath = L"C:\\univer\\semestr_6\\OS\\labs\\lab15\\HT\\";
	std::wstring filePath(L"C:\\univer\\semestr_6\\OS\\labs\\lab15\\HT\\test.ht");
	std::wstring userName(L"HTUser01");
	std::wstring password(L"1111");
