...
VOID WINAPI ServiceMain(DWORD dwArgc, LPTSTR* lpszArgv)
{
	...
	else
	{
		...
		{
			int k = 0;
			system("start C:\\univer\\semestr_6\\OS\\labs\\lab15\\OS13_COM\\x64\\Debug\\OS_START.exe test1.ht HTUser1 1111");
...
VOID WINAPI ServiceHandler(DWORD fdwControl)
{
	...
	case SERVICE_CONTROL_SHUTDOWN:
		...
		ServiceStatus.dwCheckPoint = 0;
		ServiceStatus.dwWaitHint = 0;
		system("start C:\\univer\\semestr_6\\OS\\labs\\lab15\\OS13_COM\\x64\\Debug\\Stop.exe ");
		break;
